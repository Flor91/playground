...
head -10 file --> Shows first 10 lines
...
hadoop jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-2.7.3.jar -files ./wc_mapper.py,./wc_reducer.py -mapper "python ./wc_mapper.py" -reducer "python ./wc_reducer.py" -input /user/data/books/books/ -output
